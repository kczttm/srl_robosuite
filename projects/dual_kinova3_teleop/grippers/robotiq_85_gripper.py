...
_robotiq_path = os.path.abspath(
    os.path.join(os.path.abspath(__file__), os.pardir)
)

class Robotiq85GripperBaseCorrected(GripperModel):
    """
    ...
    def __init__(self, idn=0):
        super().__init__(os.path.join(_robotiq_path, "robotiq_gripper_85.xml"), idn=idn)
...
@register_gripper
class Robotiq85GripperCorrected(Robotiq85GripperBaseCorrected):
    """
    1-DoF variant of Robotiq85GripperBaseCorrected.
    """
